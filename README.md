...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-v3jqk2a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-v3jqk2a.containers.anotherwebservice.com/
...
```
git clone git@github.com:cafaeinn/container-v3jqk2a.git
cd container-v3jqk2a
```
...
```
docker attach container-v3jqk2a
```
